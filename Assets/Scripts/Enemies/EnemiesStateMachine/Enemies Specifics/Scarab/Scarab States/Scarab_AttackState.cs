...
public class Scarab_AttackState : AttackState
{
    //Data reference
    ...
    public Scarab_AttackState(Entity entity, FiniteStateMachine stateMachine, string animBoolName, Transform attackPosition, Scarab scarab) : base(entity, stateMachine, animBoolName, attackPosition)
    {
        this.scarab = scarab;
    }
